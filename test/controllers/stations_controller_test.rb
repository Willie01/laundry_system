...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { address: @station.address, city_id: @station.city_id, factory_id: @station.factory_id, phone: @station.phone } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { address: @station.address, city_id: @station.city_id, factory_id: @station.factory_id, phone: @station.phone } }
