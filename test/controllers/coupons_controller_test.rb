...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { deadline: @coupon.deadline, price: @coupon.price, type: @coupon.type, user_id: @coupon.user_id } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { deadline: @coupon.deadline, price: @coupon.price, type: @coupon.type, user_id: @coupon.user_id } }
