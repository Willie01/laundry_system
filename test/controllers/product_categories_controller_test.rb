...
class ProductCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_category" do
    assert_difference('ProductCategory.count') do
      post product_categories_url, params: { product_category: { category_id: @product_category.category_id, product_id: @product_category.product_id, status: @product_category.status } }
    end
  ...
  test "should update product_category" do
    patch product_category_url(@product_category), params: { product_category: { category_id: @product_category.category_id, product_id: @product_category.product_id, status: @product_category.status } }
