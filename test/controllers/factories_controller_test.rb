...
class FactoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create factory" do
    assert_difference('Factory.count') do
      post factories_url, params: { factory: { address: @factory.address, name: @factory.name, password: @factory.password, phone: @factory.phone, rank: @factory.rank } }
    end
  ...
  test "should update factory" do
    patch factory_url(@factory), params: { factory: { address: @factory.address, name: @factory.name, password: @factory.password, phone: @factory.phone, rank: @factory.rank } }
