...
class PriceRulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price_rule" do
    assert_difference('PriceRule.count') do
      post price_rules_url, params: { price_rule: { city_id: @price_rule.city_id, price: @price_rule.price, start_time: @price_rule.start_time, type: @price_rule.type } }
    end
  ...
  test "should update price_rule" do
    patch price_rule_url(@price_rule), params: { price_rule: { city_id: @price_rule.city_id, price: @price_rule.price, start_time: @price_rule.start_time, type: @price_rule.type } }
