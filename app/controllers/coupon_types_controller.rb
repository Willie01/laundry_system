class CouponTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @coupon_type.save
        ...
        format.json { render :show, status: :created, location: @coupon_type }
      else
  ...
  def update
    respond_to do |format|
      if @coupon_type.update(coupon_type_params)
        ...
        format.json { render :show, status: :ok, location: @coupon_type }
      else
  ...
  def destroy
    @coupon_type.destroy
    respond_to do |format|
      format.html { redirect_to coupon_types_url, notice: 'Coupon type was successfully destroyed.' }
  ...
  private
    ...
    def coupon_type_params
      params.require(:coupon_type).permit(:coupon_type_name)
    end
end
